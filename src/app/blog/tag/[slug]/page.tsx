...
import { createTagSlug, getTagNameFromSlug, createCategorySlug } from '@/lib/utils';
    ...
    <div className="sticky top-24 space-y-8">
      ...
      <div className="p-4 bg-[#283040] rounded-lg border border-gray-700">
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map(tag => (
            <Link key={tag._id.toString()} href={`/blog/tag/${createTagSlug(tag.name)}`} className="bg-gray-700 text-gray-300 text-xs font-medium px-3 py-1 rounded-full hover:bg-gray-600 transition-colors">
              #{tag.name}
            </Link>
          ))}
        </div>
